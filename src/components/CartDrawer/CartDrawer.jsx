...
export default function CartDrawer({ cart, total, isOpen, onClose, onRemove, onOrder, onOrderForm, onUpdateQuantity }) {
  return (
    <>
      ...
      <aside className={`cartDrawer ${isOpen ? 'open' : ''}`} aria-hidden={!isOpen} aria-label="Shopping cart">
        <div className="cartHeader">
          <h3>🛍️ Your Cart</h3>
          <button className="closeBtn" onClick={onClose} aria-label="Close cart">✕</button>
        </div>
